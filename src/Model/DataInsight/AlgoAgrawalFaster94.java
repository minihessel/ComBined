...
public class AlgoAgrawalFaster94 {
    ...
    /**
     * Calculate the support of an itemset by looking at the frequent patterns of the same size. Because patterns are sorted by lexical order, we use a binary search. This is MUCH MORE efficient than just browsing the full list of patterns.
     *
...
//        throw new RuntimeException("INVALID SUPPORT - THIS SHOULD NOT HAPPEN BECAUSE ALL ITEMSETS HAVE TO BE FREQUENT");
    ...
    /**
     * Generating candidate itemsets of size k from frequent itemsets of size k-1. This is called "apriori-gen" in the paper by agrawal. This method is also used by the Apriori algorithm for generating candidates. Note that this method is very optimized. It assumed that the list of itemsets received as parameter are lexically ordered.
     *
    ...
    /**
     * Save a rule to the output file or in memory depending if the user has provided an output file path or not
     *
