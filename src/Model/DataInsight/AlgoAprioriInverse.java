 ...
 * <br/><br/>
 *
 * Yun Sing Koh, Nathan Rountree: Finding Sporadic Rules Using Apriori-Inverse. PAKDD 2005: 97-106 <br/><br/>
 *
 * and the original Apriori article:<br/><br/>
 *
 * Agrawal R, Srikant R. "Fast Algorithms for Mining Association Rules", VLDB. Sep 12-15 1994, Chile, 487-99,<br/><br/>
 *
 * The AprioriInverse algorithm finds all perfectly rare itemsets. A perfectly rare itemset is an itemset such that all its subsets are rare. It is very similar to the original Apriori algorithm. The main difference is that it uses a threshold "maxsup" and that frequent items of size 1 need to have a support not higher than maxsup.<br/><br/>
 *
