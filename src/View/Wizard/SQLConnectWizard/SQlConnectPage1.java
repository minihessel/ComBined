...
public final class SQlConnectPage1 implements WizardPage {
    ...
    public void addElements() {
        ...
        pane.add(new Label("Test Connection: "), 0, 6);
        pane.add(testConnectionButton, 1, 6);
    ...
    private void testSQLConnection() {
        try {
            SQL_manager.getConnection(txtField.getText(), txtPort.getText(), txtInstance.getText(), txtUserName.getText(), txtPassword.getText());
