 ...
 */
public class AddDragAndDropFunctionality {
...
// The Java 8 way to get the response value (with lambda expression).
        ...
        treeCell.setOnDragDropped(new EventHandler<DragEvent>() {
            public void handle(DragEvent event) {
                ...
                if (DRAGGEDSOURCE != null && DRAGGEDTARGET != null) {
                    if (DRAGGEDTARGET.getGraphic() != null) {
                        ...
                        mainFXMLController.mapOverKolonnerOgTreItems.get(treeCell.getTreeItem()).add(wizardController.tablesList.get(hvilkenTabell).listofColumns.get(DRAGGEDINDEX));
                    } else {
                        Dialogs.create()
           ...
           public void makeTreeViewDragAble(TreeView treeView) {
